...
input_img_name = 'logo.jpeg'  # checked in, I'll be using it as the running example
...
[get_new_shape(config, img.shape[:-1], i)for i in range(4)]
...
# Common params
parser.add_argument("--input", type=str, help="Input IMAGE or VIDEO name that will be used for dreaming", default='logo.jpeg')
